...
export function ReprogramarTurnoView(props: Props) {
    ...
    return <MtScreen scroll><MtHeader eyebrow={props.eyebrow} title="Reprogramar turno" subtitle="Elegí una nueva fecha y horario disponible."/>{props.notice ? <NoticeBox notice={props.notice}/> : null}<LoadedContent {...props} styles={styles}/>{props.navigation}</MtScreen>;
}
