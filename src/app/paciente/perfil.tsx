...
function ProfileHero({ profile, photoUri, pickPhoto, styles, language }: {
    profile: UserProfile | null;
...
function OtherDetailsField({ value, setValue, styles, theme }: {
    value: string;
...
function ProfileFormCard(props: {
