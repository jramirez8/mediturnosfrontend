...
function createStyles(theme: MediturnosTheme) {
  return StyleSheet.create({
    ...
    dayCell: { width: '14.2857%', aspectRatio: 1, borderRadius: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: theme.colors.surfaceMuted, borderWidth: 1, borderColor: theme.colors.border, position: 'relative', transform: [{ scale: 0.92 }] },
