...
function createStyles(theme: MediturnosTheme) {
  return StyleSheet.create({
    ...
    calendarGrid: { flexDirection: 'row', flexWrap: 'wrap', marginBottom: 4 },
    calendarCell: { width: '14.2857%', aspectRatio: 1, borderRadius: 14, borderWidth: 1, borderColor: theme.colors.border, backgroundColor: theme.colors.surfaceMuted, alignItems: 'center', justifyContent: 'center', transform: [{ scale: 0.92 }] },
    ...
    calendarSelected: { borderWidth: 3, borderColor: theme.colors.primaryDark, backgroundColor: theme.colors.primary },
    calendarText: { color: theme.colors.ink, fontWeight: '900' },
    calendarBlockedText: { color: theme.colors.danger },
    calendarSelectedText: { color: theme.mode === 'dark' ? '#06201D' : '#FFFFFF' },
