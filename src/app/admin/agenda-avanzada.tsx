...
function createStyles(theme: MediturnosTheme) {
  return StyleSheet.create({
    ...
    calendarCell: { width: '13.05%', aspectRatio: 1, borderRadius: 14, borderWidth: 1, borderColor: theme.colors.border, backgroundColor: theme.colors.surfaceMuted, alignItems: 'center', justifyContent: 'center' },
